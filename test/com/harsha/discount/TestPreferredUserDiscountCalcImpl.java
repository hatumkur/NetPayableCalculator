...
public class TestPreferredUserDiscountCalcImpl {
	...
	public void setUp() throws Exception {
		discountCalc = DiscountCalculatorFactory.createUserDiscountCalculator(EUserType.PREFERED);
	}
